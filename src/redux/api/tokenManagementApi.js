...
const { useUpdateConfigMutation, useGetConfigQuery, useGetAllTokensQuery } = tokenManagementApi;
export { tokenManagementApi, useUpdateConfigMutation, useGetConfigQuery, useGetAllTokensQuery };